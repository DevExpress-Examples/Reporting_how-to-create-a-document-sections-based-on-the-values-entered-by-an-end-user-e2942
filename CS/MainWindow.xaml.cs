...
namespace PrintDocumentFromUIWpf {
    ...
    public partial class MainWindow : DXWindow {
        ...
        private void CreateAndPreviewLink() {
            ...
            link.ReportHeader = (ControlTemplate)this.Resources["reportHeaderTemplate"];
            link.PageHeader = (ControlTemplate)this.Resources["pageHeaderTemplate"];
            link.Detail = (DataTemplate)this.Resources["detailTemplate"];
            link.PageFooter = (ControlTemplate)this.Resources["pageFooterTemplate"];
            link.ReportFooter = (ControlTemplate)this.Resources["reportFooterTemplate"];
