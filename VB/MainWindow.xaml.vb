...
Namespace PrintDocumentFromUIWpf
	...
	Partial Public Class MainWindow
		...
		Private Sub CreateAndPreviewLink()
			...
			link.ReportHeader = CType(Me.Resources("reportHeaderTemplate"), ControlTemplate)
			link.PageHeader = CType(Me.Resources("pageHeaderTemplate"), ControlTemplate)
			link.Detail = CType(Me.Resources("detailTemplate"), DataTemplate)
			link.PageFooter = CType(Me.Resources("pageFooterTemplate"), ControlTemplate)
			link.ReportFooter = CType(Me.Resources("reportFooterTemplate"), ControlTemplate)
